...
// ANSWER: O(1);
const findFourth2 = numbers => numbers[3];
...
let newNumbersA = numbers1.filter((num) => {
  return num < 5;
});
...
let newNumbersB = numbers1.map((num) => {
  return num * 3;
});
...
// ANSWER:
const getNumbersSquared2 = (numbers) => numbers.map(number => number * number);
...
// ANSWER: We are reassinging a value in the countLetters function and the other we are determining based on the amount of letters
